...
const DepartmentSetting = () => {
  ...
  const { loggedInDepartment, updateDepartmentProfile, loading } = useService();

  const [formData, setFormData] = useState({
    name: loggedInDepartment.name,
    email: loggedInDepartment.email,
    password: "",
  });
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    updateDepartmentProfile(formData);
  };
          ...
          <>
            <div className="p-6 border-b dark:border-gray-700">
              ...
              <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                This information will be displayed to you only
              </p>
              ...
              <div className="mt-6 flex flex-col sm:flex-row items-start gap-6">
                ...
                <div className="flex-1">
                  <h3 className="text-lg font-medium text-gray-900 dark:text-white">
                    {loggedInDepartment.name}
                  </h3>
                  <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                    {loggedInDepartment.email}
                  </p>
