...
function Register() {
  const { register, loading } = useService();
      ...
      <div className="w-full max-w-md bg-white rounded-xl shadow-sm overflow-hidden border border-gray-200">
        <div className="p-8 sm:p-10">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 text-sm">Get started with your university portal</p>
          </div>
          ...
          <div className="mt-6 text-center text-sm text-gray-500">
            ...
            <Link to="/" className="font-medium text-black hover:text-gray-700 flex items-center justify-center">
