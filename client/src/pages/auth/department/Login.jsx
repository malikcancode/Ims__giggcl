...
function Login() {
  const { departmentSignIn, loading } = useService();
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-10 py-3 text-sm border border-gray-200 rounded-lg focus:ring-1 focus:ring-black focus:border-black transition-all"
                  required
                />
                <div
                  type="button"
